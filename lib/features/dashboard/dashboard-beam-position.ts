import { TENANT_DASHBOARD_CONCERT_BACKDROP_ART } from "@/lib/features/dashboard/tenant-dashboard-assets";
...
const CONCERT_BACKDROP = {
  width: TENANT_DASHBOARD_CONCERT_BACKDROP_ART.width,
  height: TENANT_DASHBOARD_CONCERT_BACKDROP_ART.height,
  beamYN: 0.512,
