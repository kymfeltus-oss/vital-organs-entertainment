/** Pre-live holding room — `/public/holding-room/holding-room.png` on mobile artboard track. */
...
export const HOLDING_ROOM_ASSETS = {
  mobileBackground: `/holding-room/holding-room.png?v=${HOLDING_ROOM_ASSET_VERSION}`,
} as const;
