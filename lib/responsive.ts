...
export const MOBILE_TAB_TRACK_WIDTH =
  "min(100vw, calc((100dvh - var(--bottom-dock-display-h, 52px) - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px)) * 1080 / 1920))" as const;
...
export const CONTENT_WITH_NAV =
  "pb-[calc(var(--bottom-dock-display-h,52px)+env(safe-area-inset-bottom))]";
