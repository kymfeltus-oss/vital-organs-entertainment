...
class AllenHeathDriver(MixerDriver):
    mixer_type = "allen_heath"
    ...
    def get_console_info(self, ip: str, port: int = 10023, timeout_ms: int = 2000) -> dict:
        return {"ok": False, "message": "Allen & Heath support is coming soon."}
    ...
    def health_check(self, ip: str, port: int = 10023, timeout_ms: int = 2000) -> dict:
        return {"success": False, "message": "Allen & Heath support is coming soon.", "checks": [], "warnings": []}

    def audio_detection(self, ip: str, port: int = 10023, timeout_ms: int = 3000) -> dict:
        return {"success": False, "message": "Allen & Heath support is coming soon.", "inputs": [], "noSignalDetected": True}
