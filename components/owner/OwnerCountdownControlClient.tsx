...
export default function OwnerCountdownControlClient() {
  ...
  }, [dateTimeLocal, eventName, hostNames, pending, presenterName, setup, timezone]);
    ...
    <main className="min-h-screen bg-[#030611] px-4 py-6 text-white sm:px-6 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-5">
          <div>
            <Link href="/owner/control" className="inline-flex items-center gap-2 font-ui text-xs uppercase tracking-[0.16em] text-[#00DDEB]">
