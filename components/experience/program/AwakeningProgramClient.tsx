...
const PROGRAM_SOCIAL_ICONS = {
  facebook: "/program/Facebook_Logo.png",
  instagram: "/program/instagram.%20png",
} as const;
...
function ProgramSocialLinks({ person }: { person: AwakeningProgramPerson }) {
    ...
    return (
      <>
        <div className="awakening-program-offering-art">
          <Image
            src="/vital%20seed/mobile-main-backgroundb.png"
            alt="Vital Seed"
            width={1254}
            height={1254}
          ...
          <aside className="awakening-program-side" aria-label="Event details">
            ...
            <section>
              ...
              <div className="awakening-program-featured">
                <Image
                  src="/awakening/speakers/ian-craig.webp"
