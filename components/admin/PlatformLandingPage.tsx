...
function ParableWordmark({ size = "nav" }: { size?: "nav" | "phone" }) {
  ...
  return (
    <div className="flex items-baseline gap-2">
      ...
      <span className="text-[10px] font-bold tracking-[0.55em] text-[#F5B400] uppercase">
...
function TabletMockup() {
  return (
    <div
      className="faith-device-float relative w-[min(100%,440px)] rounded-[1.45rem] border border-white/14 bg-[rgba(255,255,255,0.05)] p-3.5 shadow-[0_50px_140px_rgba(0,0,0,0.85),0_0_80px_rgba(245,180,0,0.08)] backdrop-blur-2xl"
      aria-hidden="true"
    >
      <div className="pointer-events-none absolute -inset-px rounded-[1.45rem] bg-[linear-gradient(135deg,rgba(245,180,0,0.22),transparent_38%,transparent_62%,rgba(255,255,255,0.08))] opacity-70" />

      <div className="relative mb-2.5 flex items-center justify-between px-1">
        <div className="flex items-center gap-2.5">
          <span className="faith-live-pulse rounded-full border border-[#F5B400]/35 bg-[#F5B400] px-2.5 py-0.5 text-[9px] font-bold tracking-[0.22em] text-black uppercase shadow-[0_0_18px_rgba(245,180,0,0.45)]">
            Live
          </span>
        ...
        <span className="faith-signal-dot h-2 w-2 rounded-full bg-[#F5B400] shadow-[0_0_14px_#F5B400]" />
      </div>
      ...
      <div className="relative mb-3 overflow-hidden rounded-xl border border-white/12 bg-black">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_42%,rgba(245,180,0,0.34),transparent_58%)]" />
        <div className="faith-light-sweep absolute inset-0 opacity-40" />
        <div className="absolute inset-x-0 bottom-0 h-1/2 bg-[linear-gradient(180deg,transparent,rgba(245,180,0,0.14))]" />
        <div className="relative flex aspect-[16/10] items-center justify-center">
          <div className="absolute h-[72%] w-[72%] rounded-full bg-[radial-gradient(circle,rgba(245,180,0,0.16)_0%,transparent_68%)]" />
          <SanctuaryArchIcon />
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <div className="rounded-lg border border-white/12 bg-[rgba(255,255,255,0.03)] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
            ...
            {["$50", "$100", "$250"].map((amount) => (
              <span
                ...
                className={`rounded px-2 py-0.5 text-[8px] tracking-wide transition-colors ${
                  amount === "$250"
                    ? "border border-[#F5B400]/55 bg-[#F5B400]/14 text-[#F5B400] shadow-[0_0_12px_rgba(245,180,0,0.18)]"
          ...
          <p className="mt-2.5 text-[8px] font-bold tracking-[0.2em] text-[#F5B400] uppercase">
            Give Now →
          </p>
...
function PhoneMockup() {
  return (
    <div
      className="faith-device-float-delayed relative w-[178px] rounded-[2.1rem] border border-white/14 bg-[rgba(255,255,255,0.05)] p-3 shadow-[0_40px_100px_rgba(0,0,0,0.82),0_0_50px_rgba(245,180,0,0.1)] backdrop-blur-2xl"
      aria-hidden="true"
    >
      <div className="pointer-events-none absolute -inset-px rounded-[2.1rem] bg-[linear-gradient(160deg,rgba(245,180,0,0.18),transparent_45%)] opacity-80" />
      ...
      <div className="relative overflow-hidden rounded-[1.35rem] border border-white/12 bg-black px-4 py-7 text-center">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_18%,rgba(245,180,0,0.12),transparent_55%)]" />
        ...
        <div className="faith-cta-glow relative mt-6 rounded border border-[#F5B400]/45 bg-[#F5B400]/10 px-2.5 py-2.5 text-[8px] font-bold tracking-[0.22em] text-[#F5B400] uppercase">
...
function DeviceHeroComposition() {
  return (
    <div className="relative mx-auto flex min-h-[380px] w-full max-w-[580px] items-center justify-center sm:min-h-[460px] [perspective:1400px]">
      <div className="faith-aurora pointer-events-none absolute left-1/2 top-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(245,180,0,0.16)_0%,transparent_68%)] blur-2xl sm:h-[340px] sm:w-[340px]" />
      <div className="faith-aurora-delayed pointer-events-none absolute right-[8%] top-[18%] h-[180px] w-[180px] rounded-full bg-[radial-gradient(circle,rgba(245,180,0,0.1)_0%,transparent_70%)] blur-3xl sm:h-[220px] sm:w-[220px]" />

      <div className="absolute left-[6%] top-[12%] z-0 h-20 w-20 rounded-full border border-[#F5B400]/10 bg-[#F5B400]/5 blur-sm sm:h-28 sm:w-28" />
    ...
    <div className="faith-landing min-h-screen overflow-x-hidden bg-[#000000] text-white antialiased">
      <style>{`
        ...
        @keyframes faith-live-pulse {
          0%, 100% { box-shadow: 0 0 12px rgba(245,180,0,0.35); }
          50% { box-shadow: 0 0 22px rgba(245,180,0,0.65); }
        }
        ...
        @keyframes faith-cta-glow {
          0%, 100% { box-shadow: inset 0 0 0 rgba(245,180,0,0); }
          50% { box-shadow: inset 0 0 18px rgba(245,180,0,0.12); }
        }
        ...
        .faith-light-sweep {
          background: linear-gradient(105deg, transparent 0%, rgba(245,180,0,0.18) 48%, transparent 100%);
          animation: faith-light-sweep 6.5s ease-in-out infinite;
        }
        .faith-stage-glow {
          background: radial-gradient(circle at 50% 45%, rgba(245,180,0,0.28) 0%, transparent 62%);
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_55%_at_72%_0%,rgba(245,180,0,0.11),transparent_62%)]"
        aria-hidden="true"
      />
      <div
      ...
      <header className="relative z-20 border-b border-white/10">
        ...
        >
          ...
          <Link
            href="/onboarding"
            className="inline-flex items-center rounded border border-[#F5B400]/55 bg-transparent px-4 py-2 text-[10px] font-semibold tracking-[0.28em] text-[#F5B400] uppercase transition-all duration-300 hover:border-[#F5B400] hover:bg-[#F5B400]/8 hover:text-white"
          >
            Console Registry →
          </Link>
        </nav>
        ...
        <section className="relative z-10 mx-auto max-w-7xl px-6 pt-14 pb-10 md:px-10 md:pt-20 md:pb-16">
          <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-10">
            <div className="faith-hero-copy lg:col-span-6">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#F5B400]/30 bg-[#F5B400]/8 px-3 py-1.5 shadow-[0_0_24px_rgba(245,180,0,0.12)]">
                <span className="faith-signal-dot h-1.5 w-1.5 rounded-full bg-[#F5B400] shadow-[0_0_10px_#F5B400]" />
                <span className="text-[9px] font-medium tracking-[0.32em] text-[#F5B400] uppercase">
                  Faith Infrastructure System Core
                </span>
              </div>

              <h1 className="max-w-2xl font-extrabold leading-[0.98] tracking-[-0.03em] uppercase md:text-5xl lg:text-[3.35rem] text-4xl">
                {FAITH_BRAND_MESSAGING.headlines[2]}
              </h1>

              <p className="mt-6 max-w-xl text-sm leading-relaxed text-[#B3B3B3] md:text-[15px]">
                {FAITH_BRAND_POSITION} Deploy a completely independent, white-labeled streaming
                network under your church&apos;s name — broadcast-grade, executive, and built to
                scale.
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link
                  href="/onboarding"
                  className="inline-flex h-11 items-center justify-center rounded bg-[#F5B400] px-6 text-[10px] font-bold tracking-[0.24em] text-black uppercase transition-all duration-300 hover:opacity-90 hover:shadow-[0_0_28px_rgba(245,180,0,0.22)]"
                >
              ...
              <p className="mt-8 text-[9px] font-mono tracking-[0.28em] text-[rgba(255,255,255,0.68)] uppercase">
                ...
                <span className="text-[#F5B400]">Own Your Ministry</span>
              </p>
            </div>
        ...
        >
          <div className="mx-auto grid max-w-7xl gap-px bg-white/10 md:grid-cols-2 lg:grid-cols-4">
            {FEATURE_STRIP.map(({ icon: Icon, label, description }) => (
              <article
                key={label}
                className="group relative overflow-hidden bg-[rgba(255,255,255,0.04)] px-6 py-7 backdrop-blur-md transition-all duration-500 hover:bg-[rgba(255,255,255,0.07)] hover:shadow-[inset_0_1px_0_rgba(245,180,0,0.25)]"
              >
                <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,rgba(245,180,0,0.45),transparent)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                <Icon
                  className="mb-4 h-5 w-5 stroke-[1.5] text-white/55 transition-colors duration-300 group-hover:text-[#F5B400]"
                  aria-hidden="true"
                />
