...
import dashboardKnob from "@/app/enterprise/coleman/dashboard_knob.png";
    ...
    <div className="coleman-dashboard-knob mx-auto">
      ...
      <div className="coleman-dashboard-knob__frame relative">
        ...
        <div className="coleman-dashboard-knob__readout pointer-events-none absolute inset-0 flex flex-col items-center justify-center text-center">
          <span className="coleman-dashboard-knob__readout-mask" aria-hidden />
          <span className="coleman-heading relative z-[1] text-[17px] font-bold leading-none">
            {liveFallback(currentKey)}
          </span>
          <span className="relative z-[1] mt-0.5 text-[9px] font-normal tracking-[0.1em] text-[var(--cp-muted)]">
...
function Pill({ children }: { children: ReactNode }) {
  return (
    <span className="coleman-glass-btn inline-block rounded-full px-2 py-0.5 text-[10px] font-normal tracking-wide text-[var(--cp-taupe)] shadow-none">
      {children}
    </span>
  );
}
    ...
    <section className="coleman-intelligence-card coleman-glass-panel-deep relative z-10 rounded-[26px] px-4 py-4">
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <span className="coleman-heading text-[11px] font-semibold tracking-[0.18em]">
            COLEMAN INTELLIGENCE
          </span>
        </div>
        <span className="coleman-intelligence-status coleman-glass-btn inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-[10px] font-medium tracking-[0.14em] text-[var(--cp-espresso)] shadow-none">
          <span
            className={`coleman-intelligence-status__dot ${showPulse ? "is-live animate-pulse" : ""}`}
            aria-hidden
          />
          {statusLabel}
        </span>
      ...
      <div className="coleman-intelligence-grid grid grid-cols-[1fr_auto_1fr] items-stretch gap-1">
        <div className="coleman-intelligence-col space-y-3">
          <div>
            <p className="coleman-label">FUNCTION</p>
            <p className="coleman-heading mt-1 text-[14px] font-semibold tracking-wide">
          ...
          <div>
            ...
            <p className="coleman-heading mt-1 text-[14px] font-semibold">
              {liveFallback(intelligence.cadencePotential)}
            </p>
            <div className="mt-1.5 h-[3px] overflow-hidden rounded-full bg-white/55">
              <div
        ...
        <div className="coleman-intelligence-col space-y-3 text-right">
          <div>
            <p className="coleman-label">NASHVILLE NUMBER</p>
            <p className="coleman-heading mt-1 text-[28px] font-bold leading-none">
      ...
      <div className="coleman-intelligence-divider my-3 h-px bg-gradient-to-r from-transparent via-white/50 to-transparent" />

      <p className="coleman-label coleman-intelligence-voicings-label">SUGGESTED VOICINGS</p>
      <div className="coleman-intelligence-voicings">
        {intelligence.suggestedVoicings.map((voicing) => (
          <span key={voicing} className="coleman-voicing-pill">
            {voicing}
          </span>
        ))}
        <button
          type="button"
          className="coleman-voicing-add"
          aria-label="Add a suggested voicing"
        >
